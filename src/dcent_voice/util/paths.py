...
``docs/FRESH_MACHINE_IMPLEMENTATION_PLAN.md`` WS6/WS1).
"""
...
def user_data_dir(app_name: str = APP_NAME, *, appauthor: bool | str | None = False) -> Path:
...
def user_state_dir(app_name: str = APP_NAME, app_author: bool | str | None = False) -> Path:
